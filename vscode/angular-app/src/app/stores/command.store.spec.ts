...
import { CommandExecution, CommandResult, QueuedCommand } from '../models';
...
describe('CommandStore', () => {
  ...
  describe('command queueing', () => {
    it('should queue commands with priority ordering', () => {
      const highPriorityCmd: QueuedCommand = {
        id: 'high-1',
        action: 'aiDebug',
      ...
      const normalPriorityCmd: QueuedCommand = {
        id: 'normal-1',
        action: 'nxTest',
        project: 'test-project',
        priority: 'normal',
      ...
      const lowPriorityCmd: QueuedCommand = {
        id: 'low-1',
        action: 'gitDiff',
        project: 'test-project',
        priority: 'low',
  ...
  describe('command analytics', () => {
    ...
    it('should organize commands by project', () => {
      const project1Result: CommandResult = {
        id: 'cmd-1',
        action: 'aiDebug',
        project: 'project-1',
        status: 'success',
      ...
      const project2Result: CommandResult = {
        id: 'cmd-2',
        action: 'nxTest',
        project: 'project-2',
        status: 'success',
    ...
    it('should organize commands by action', () => {
      const aiDebugResult: CommandResult = {
        id: 'cmd-1',
        action: 'aiDebug',
        project: 'test-project',
        status: 'success',
      ...
      const nxTestResult: CommandResult = {
        id: 'cmd-2',
        action: 'nxTest',
        project: 'test-project',
        status: 'success',
  ...
  describe('batch operations', () => {
    it('should cancel all commands', () => {
      const execution1: CommandExecution = {
        id: 'test-1',
        action: 'aiDebug',
        project: 'test-project',
        status: 'running',
      ...
      const execution2: CommandExecution = {
        id: 'test-2',
        action: 'nxTest',
        project: 'test-project',
        status: 'running',
