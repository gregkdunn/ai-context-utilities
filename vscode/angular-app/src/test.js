...
exports.waitForSignalUpdate = exports.createMockCommand = exports.createMockProject = exports.createMockWebviewState = exports.createMockVSCodeApi = void 0;
...
window.simulateVSCodeMessage = (data) => {
    const callback = window.messageCallback;
    if (callback) {
        callback({ data });
    }
};
...
exports.createMockVSCodeApi = createMockVSCodeApi;
const createMockWebviewState = () => ({
    projects: [],
    currentProject: '',
    actions: {},
    outputFiles: {},
...
exports.createMockWebviewState = createMockWebviewState;
...
const waitForSignalUpdate = async () => {
    await new Promise(resolve => setTimeout(resolve, 0));
};
exports.waitForSignalUpdate = waitForSignalUpdate;
