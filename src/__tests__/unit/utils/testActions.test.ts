...
describe('TestActions', () => {
    ...
    beforeEach(() => {
        ...
        // Mock copilotDebugTests to prevent automatic Copilot calls
        jest.spyOn(testActions as any, 'copilotDebugTests').mockResolvedValue(undefined);
    ...
    describe('Menu Structure', () => {
        ...
        test('should have correct menu items for failure', async () => {
            ...
            await testActions.showTestResult(failureResult);
    ...
    describe('Back Button Navigation', () => {
        ...
        test('should have consistent Back button across all menus', () => {
            const testResults = [
                {
            ...
            testResults.forEach(result => {
                ...
                testActions.showTestResult(result as TestSummary);
